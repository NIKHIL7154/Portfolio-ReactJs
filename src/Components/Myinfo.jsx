...
const Myinfo = () => {
  ...
  return (
    ...
    <div className='flex-col md:flex-row flex mt-4 md:mt-16 justify-start md:justify-between items-center pt-1 px-4 md:p-10'>
      <img className='mb-[20px] w-[300px] md:w-[450px] lg:w-[600px]' src={Devicon} alt="Nothing" />
      <div className='text-center md:text-left'>
        <h1 className='font-bold text-xl md:text-3xl'>Hello👋<br></br>I'm Nikhil Thakur<br></br>A Front End Developer🧑‍💻</h1>
        ...
        touch.</h1>
        <button onClick={()=>{
          window.open('https://www.linkedin.com/in/nikhil-thakur-99b4a627b/', '_blank');
